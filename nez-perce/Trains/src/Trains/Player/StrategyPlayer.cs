...
namespace Trains.Player
{
    ...
    public class StrategyPlayer : IPlayer
    {
        ...
        /// <summary>
        /// TESTING Constructor for making a Player from a dynamically loaded strategy.
        ...
        public StrategyPlayer(string name, string filepath, TrainsMap map)
        {
            Name = name;
            _map = map;
            _gameState = null;
        ...
        {
            ImmutableHashSet<Connection> claimedConnections = new HashSet<Connection>().ToImmutableHashSet();
            _gameState = new PlayerGameState(GamePhase.SetUp, int.MaxValue, claimedConnections, new List<ImmutableHashSet<Connection>>().ToImmutableList(), map.Connections.ToImmutableHashSet(),
        ...
        /// <summary>
        /// House players are also used for testing. They submit the map property they have for a tournment. _map will only be set
        /// via the constructor when using the testing constructor.
        /// </summary>
