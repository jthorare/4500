...
namespace Trains.Admin
{
    ...
    public class Deck : ICloneable
    {
        ...
        public Deck(Dictionary<Color, uint> coloredCards, List<Destination> destinations, Random random)
        {
        ...
        public Deck(Dictionary<Color, uint> coloredCards, List<Destination> destinations) : this(coloredCards, destinations, new Random())
        { }
        ...
        /// and </returns>
        public virtual Cards DrawCards(uint numOfCards)
        {
            var returnCards = new Cards();
        ...
        public virtual List<Destination> GetDestinations()
        {
        ...
        {
            return new Deck(new Dictionary<Color, uint>(ColoredCards), new List<Destination>(Destinations));
        }
    }
}
