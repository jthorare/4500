...
namespace Trains.Tests.Common.Map.Json
{
    ...
    public class TrainsMapJsonConverterTest
    {
        ...
        [TestMethod]
        public void TrainsMapJsonConverterTestReserialize()
        {
            const string mapJson = "{\"width\":100,\"height\":100,\"cities\":[[\"City1\",[0,0]],[\"City2\",[100,100]]],\"connections\":{\"City1\":{\"City2\":{\"red\":3}}}}";
            var map = JsonConvert.DeserializeObject<TrainsMap>(mapJson);
            
            TrainsMapJsonConverter.ContextHeight = 100;
            TrainsMapJsonConverter.ContextWidth = 100;
            var serializedJson = JsonConvert.SerializeObject(map);
            
            Assert.IsTrue(mapJson.Equals(serializedJson));
        }
        ...
        public void TrainsMapJsonConverterTestSerialize()
        {
            ...
            TrainsMapJsonConverter.ContextHeight = 800;
            TrainsMapJsonConverter.ContextWidth = 800;
            Console.WriteLine(JsonConvert.SerializeObject(map));
        }

        [TestMethod]
        public void TrainsMapJsonConverterTestFailContext()
        {
            const string mapJson = "{\"width\":100,\"height\":100,\"cities\":[[\"City1\",[0,0]],[\"City2\",[100,100]]],\"connections\":{\"City1\":{\"City2\":{\"red\":3}}}}";
            var map = JsonConvert.DeserializeObject<TrainsMap>(mapJson);
            
            // Missing width and height context
            TrainsMapJsonConverter.ContextHeight = null;
            TrainsMapJsonConverter.ContextWidth = null;
            Assert.ThrowsException<JsonException>(() => JsonConvert.SerializeObject(map));
            
            // Missing width context
            TrainsMapJsonConverter.ContextHeight = 100;
            Assert.ThrowsException<JsonException>(() => JsonConvert.SerializeObject(map));
            
            // Missing height context
            TrainsMapJsonConverter.ContextHeight = null;
            TrainsMapJsonConverter.ContextWidth = 100;
