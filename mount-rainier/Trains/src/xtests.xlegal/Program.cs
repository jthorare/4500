...
namespace xtests.xlegal
{
    internal static class Program
    {
        internal static void Main(string[] args)
        {
            ...
            claimedConnections.Add(playerConnections.ToImmutableHashSet());
            ...
            PlayerGameState playerGameState = new PlayerGameState(GamePhase.InProgress, 1000, claimedConnections.ToImmutableList(),
                availableConnections.ToImmutableHashSet(), playerInv);
